...
class register extends moodleform {
    ...
    public function definition() {
        ...
        $mform->setDefault('country', 'GR');

        $mform->addElement('text', 'mobile', 'Phone');  // An element in the form
        $mform->setType('mobile', PARAM_NOTAGS);           //the type of the element
        $mform->setDefault('mobile', 'type your mobile'); //Default value
